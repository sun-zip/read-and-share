...
public class FollowApiController {
    ...
    public ResponseEntity<Void> follow(@PathVariable String toMemberEmail, @Parameter(hidden = true) @SignInMember Member fromMember) {
    ...
    public ResponseEntity<Void> unfollow(@PathVariable String toMemberEmail, @Parameter(hidden = true) @SignInMember Member fromMember) {
